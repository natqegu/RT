...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/09/29 22:24:53 by vkarpova          #+#    #+#             */
/*   Updated: 2019/09/29 22:24:54 by vkarpova         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		parse_plane(t_global *g, char **data, int i)
{
	...
	plane_2(g);
	g->obj[g->id].base[0] = rotate(g->obj[g->id].base[0], g->obj[g->id].ang);
	g->obj[g->id].base[1] = rotate(g->obj[g->id].base[1], g->obj[g->id].ang);
	g->obj[g->id].base[2] = rotate(g->obj[g->id].base[2], g->obj[g->id].ang);
	return (0);
}
